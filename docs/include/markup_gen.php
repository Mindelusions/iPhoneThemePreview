...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Theme Creator Markup Generator</title>
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js" type="text/javascript" charset="utf-8"></script>
		 <script type="text/javascript" charset="utf-8">
			var old = ["Text", "Calendar", "Photos", "Camera", "YouTube", "Stocks", "Maps", "Weather", "Clock", "Calculator", "Notes", "Settings", "iTunes", "AppStore", "Contacts", "Phone", "Mail", "Safari", "iPod"];
			var exists = {};
			$.each(old, function() {
				exists[this] = 1;
			});
		 	var css_tmpl = '#iphone .${class}{background:url(${icon}) center center no-repeat;}\n#dock .${class}{background:url(${icon}) center 10px no-repeat;}\n\n';
		 	var mu_tmpl = '<div class="ico ${class}">${class}</div>';
		 	
			function getIcons() {
				var css = "#screen{background-image:url("+ $("#t").val() +"/Wallpaper.png);}\n\n";
				var mu = "";
				var url = "markup_gen.php?t=" + $("#t").val();
